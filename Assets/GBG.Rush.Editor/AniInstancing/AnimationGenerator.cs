...
//                     AnimatorClipInfo info = new AnimatorClipInfo();
...
//                 bake.layer = layer;
//                 bake.info = new AnimatorClipInfo();
...
//             {
//                 AnimatorClipInfo info = (AnimatorClipInfo)obj;
...
//             {
//                 var info = (AnimatorClipInfo)infoList[i];
//                 frames[i] = Mathf.CeilToInt(info.clip.frameRate * info.clip.length);
//             }
...
//                     {
//                         var info = obj as AnimationClip;
//                         if (Animator.StringToHash(info.name) == matrixData.stateName)
//                         {
